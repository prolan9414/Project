...
public class Inputter {
    ...
    public static int inputInt(String msg, String name){
        ...
        while(check){
            try{
                ...
                check=false;
                if(data<=0){
                    System.out.println(name+" cannot be equal or smaller than 0. Please enter again");
                    check=true;
                }
    ...
    public static int inputInt2(String msg, String name){
        boolean check=true;
        System.out.print(msg);
        int data=0;
        while(check){
            try{
                ...
                check=false;
                if(data<0){
                    System.out.println(name+" cannot be smaller than 0. Please enter again");
                    check=true;
                }
            }catch(NumberFormatException e){
                System.out.println("Wrong format!!! Please enter again.");
